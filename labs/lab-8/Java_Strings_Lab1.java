...
public class Java_Strings_Lab1 {
  public static void main(String[] args)
  {
     ...
     */
      ...
      outputString = outputString + inputString.charAt(2);
      outputString = outputString + inputString.charAt(22);
      outputString = outputString + inputString.charAt(23);
      outputString = outputString + inputString.charAt(5);
      outputString = outputString + inputString.charAt(24);
      outputString = outputString + inputString.charAt(3);
      outputString = outputString + inputString.charAt(16);
      outputString = outputString + inputString.charAt(5);
      outputString = outputString + inputString.charAt(42);
      outputString = outputString + inputString.charAt(6);
      outputString = outputString + inputString.charAt(31);
